...
import { FaBath, FaBed, FaTree, FaUtensils, FaFootballBall, FaCouch, FaTv, FaWineGlassAlt, FaWifi, FaParking, FaHandHoldingHeart, FaUserShield, FaInfoCircle, FaLanguage } from 'react-icons/fa';
  ...
  return (
    ...
    <div className="fs-column-list">
      ...
      <div className="fs-column">
        ...
        <h2><FaTree /> Outdoors</h2>
        <ul>
          <li>Outdoor Furniture</li>
          <li>Terrace</li>
        </ul>
        <h2><FaUtensils /> Kitchen</h2>
        <ul>
          <li>Electric Kettle</li>
          <li>Refridgerator</li>
        </ul>
        <h2><FaFootballBall /> Activities</h2>
        <ul>
          <li>Live Sports Events</li>
        </ul>
        <h2><FaCouch />Livining Area</h2>
        <ul>
          <li>Desk</li>
        </ul>
        <h2><FaTv />Media & Technology</h2>
        <ul>
      ...
      <div className="fs-column">
        ...
        <h2><FaWifi /> Internet</h2>
        <ul>
          <li>Free Wifi it available in all areas</li>
        </ul>
        <h2><FaParking /> Parking</h2>
        <ul>
        ...
        <h2><FaHandHoldingHeart /> Reception Services</h2>
        <ul>
          <li>List item 1</li>
        </ul>
      </div>
      <div className="fs-column">
        ...
        <h2><FaLanguage /> Languages spoken</h2>
        <ul>
          <li>English</li>
        </ul>
      </div>
